...
class AnnotationTransform(object):
    ...
    def __call__(self, target):
        ...
        for obj in target.iter('object'):
            ...
            # ignore small faces
            if np.max([bndbox[2]-bndbox[0],bndbox[3]-bndbox[1]])<50:
                continue
...
class VOCDetection(data.Dataset):
    ...
    def show(self, index):
        ...
        cv2.imwrite('./result/image%d.jpg'%index, img)

#ds = VOCDetection('/data/datasets/face-detection/', [('201806155', 'trainval')],None, AnnotationTransform())
