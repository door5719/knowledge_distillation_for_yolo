...
# ---------------------------------------------------------------------------- #
#####TEACHER MODEL
__C.TEACHER_MODEL = AttrDict()
__C.TEACHER_MODEL.NETS = 'vgg16'
__C.TEACHER_MODEL.SSDS = 'ssd'

# Whether use half precision for the model. currently only inference support.
__C.TEACHER_MODEL.HALF_PRECISION = True

# image size for ssd
__C.TEACHER_MODEL.IMAGE_SIZE = [300, 300]

# number of the class for the model
__C.TEACHER_MODEL.NUM_CLASSES = 21
